...
class _OverallInventoryPageState extends State<OverallInventoryPage> {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Row(
                          children: [
                            // ✅ UPDATED CATEGORY DROPDOWN - Left-Aligned with Arrow
                            _buildCompactDropdown<CategoryLabel>(
                              value: _selectedCategory,
                              items: CategoryLabel.entries,
                              onChanged: (value) {
                            ...
                            // ✅ UPDATED LOCATION DROPDOWN - Left-Aligned with Arrow
                            _buildCompactDropdown<LocationLabel>(
                              value: _selectedLocation,
                              items: LocationLabel.entries,
                              onChanged: (value) {
                            ...
                            // ✅ UPDATED ADD BUTTON - Cohesive Size
                            InkWell(
  ...
  // ✅ HELPER WIDGET - LEFT-ALIGNED TEXT WITH ARROW ICON
    ...
    return Container(
      ...
      child: DropdownButton<T>(
        ...
        selectedItemBuilder: (BuildContext context) {
          return items.map<Widget>((DropdownMenuEntry<T> entry) {
            // ✅ LEFT-ALIGNED TEXT (like in screenshot)
            return Align(
...
class _SchoolSuppliesState extends State<_SchoolSupplies> {
                ...
                children: [
                  ...
                  ..._items.asMap().entries.map(
                        (entry) => TableRow(
                          ...
                          children: <Widget>[
                            _buildBodyCell(context, entry.value.name, Alignment.centerLeft),
                            _buildBodyCell(context, entry.value.category, Alignment.center),
                            _buildBodyCell(context, entry.value.price, Alignment.center),
                            _buildBodyCell(context, entry.value.quantity, Alignment.center),
                            Container(
                              height: 40,
  ...
  Widget _buildHeaderCell(BuildContext context, String label, Alignment alignment) {
    return Container(
      height: 44,
  ...
  Widget _buildBodyCell(BuildContext context, String text, Alignment alignment) {
    return Container(
      height: 44,
      padding: const EdgeInsets.symmetric(horizontal: 12.0),
      alignment: alignment,
