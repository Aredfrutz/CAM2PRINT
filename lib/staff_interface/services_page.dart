...
class _StaffServicesPageState extends State<StaffServicesPage> {
  ...
  // ✅ Simple full-screen image - tap outside to close
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildSidebarItem(Icons.design_services, "Services", () => _navigateTo('Services'), isActive: true),
        ...
        currentItems.isEmpty
            ...
            : LayoutBuilder(
                builder: (context, constraints) {
                  final crossAxisCount = math.max(2, math.min(8, (constraints.maxWidth / 140).floor()));
