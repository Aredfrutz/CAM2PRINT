...
class _StaffProfileState extends State<StaffProfile> {
  ...
  // Static staff info
  final String _staffName = 'Name of Staff';
  final String _employeeType = 'Full Time Employee';
  final String _shopBranch = 'Main Branch';
  ...
  String _getAttendanceKey(int day, {DateTime? photoDate}) {
    ...
    return '${refDate.year}-${refDate.month}-$day';
  }
  ...
  void _submitAttendance() {
    ...
    setState(() {
      ...
      _attendanceData[key]!['hasProofPhoto'] = 'true';
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          '✅ Time In logged: $_autoTimeIn on ${_verificationPhotoDate!.day}/${_verificationPhotoDate!.month}',
        ),
        backgroundColor: Colors.green,
      ),
    );
